...
page+="    <link rel=\"shortcut icon\" href=\"./assets/favicon.ico\" />";
...
page+="                    <!--<option value=\"audi\">Audi</option> -->";
...
page+="    name: 'Voltage',";
page+="    data: [10, 3, 11, 12, 123, 123, 123, 123, 123, 123, 123, 123, 123]";
page+="  }, {";
page+="    showInLegend: true,";
page+="    name: 'Amperes',";
page+="    data: [15, 21, 3, 1, 0]";
page+="  }],";
page+="  plotOptions: {";
...
page+="    //title: { text: 'Temperature (Fahrenheit)' }";
page+="  },";
...
page+="    }";
page+="  };";
page+="  xhttp.open(\"GET\", \"/temperature\", true);";
page+="  xhttp.send();";
page+="}, 30000 ) ;";
page+="";
page+="";
